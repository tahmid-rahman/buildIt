...
import { githubProvider, googleProvider } from "./handleProvider";
      ...
      <div className="flex justify-center items-center h-[90vh]">
        <div className="w-[400px] border-[1px] border-black dark:border-[#262626] px-5 py-7 rounded-xl">
          ...
          <div className="flex justify-between my-2">
            <form action={googleProvider} className="w-full mr-2">
              <Button className="bg-slate-100 w-full hover:bg-slate-300 shadow-md border-[#262626]">
                <span className="">
            ...
            <form action={githubProvider} className="w-full ml-2">
              <Button className="bg-slate-100 w-full hover:bg-slate-300 shadow-md border-[#262626]">
                <span className="">
